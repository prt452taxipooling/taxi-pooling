 ...
 * 
 */
public class NestedPoolingNotification extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v= inflater.inflate(R.layout.notification_create_pooling, container, false);
		...
		//ADDING NOTIFICATION INTO NOTIFICATION LIST_______________________________________________(!)
   		...
   		image_id = R.drawable.picon_selected;
   		  ...
   		  adapter = new NotificationAdapter(getActivity(),Not.userID,Not.senderList, Not.srcList, Not.desList, Not.dateTime, Not.poolingID);
